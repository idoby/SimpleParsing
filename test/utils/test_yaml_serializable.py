...
YamlSerializable.subclasses.clear()
...
def test_forward_ref_list(silent):
    ...
    @dataclass
    class JLossWithList(YamlSerializable):
        name: str = ""
        total: float = 0.
...
def test_from_dict_raises_error_on_failure():
    ...
    @dataclass
    class Something(YamlSerializable):
        name: str
        age: int = 0
...
def test_set_field():
    ...
    class Person(YamlSerializable, Hashable):
        name: str = "Bob"
        age: int = 0
...
def test_used_as_dict_key():
    ...
    @dataclass
    class Leaderboard(YamlSerializable):
